...
TRADEBOT_MAX_DRAWDOWN    = 40.0   # v4.4: abaissé à 40% — copytrading exige stabilité
...
async def cmd_toptraders(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "• Récupération du leaderboard Hyperliquid (top 500)\n"
...
async def cmd_tb_aide(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = (
        ...
        "Sélectionne les *5 meilleurs traders globaux* (top 500 Hyperliquid)\n"
